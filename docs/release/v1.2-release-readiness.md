...
This checklist helps contributors prepare a **v1.2.0** release for OBS Duel Recorder.

Scope:
- Documentation and verification steps for **v1.2 - Export System** readiness.
...
- [x] ZIP structure and manifest tests pass.
- [x] SQLite and metadata export tests pass.
- [x] Screenshot export and missing-file manifest tests pass.
- [x] Video linkage export tests pass.
- [x] Secret/log exclusion tests pass.
